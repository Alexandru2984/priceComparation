...
urlpatterns = [
    ...
    path("jurnal/", app_admin_required(views.activity_log), name="activity_log"),
    path("exporturi/", app_admin_required(views.data_export_index), name="data_export_index"),
    path("exporturi/descarca/", app_admin_required(views.data_export_download), name="data_export_download"),
    path("operare/", app_admin_required(views.operations), name="operations"),
    ...
    path("configurare/import-initial/sablon/", app_admin_required(views.initial_import_template), name="initial_import_template"),
    path("configurare/import-initial/<int:pk>/", app_admin_required(views.initial_import_detail), name="initial_import_detail"),
    path("configurare/import-initial/<int:pk>/aplica/", app_admin_required(views.initial_import_confirm), name="initial_import_confirm"),
    ...
    path("furnizori/liste-pret/importa/", app_admin_required(views.supplier_price_import_create), name="supplier_price_import_create"),
    path("furnizori/liste-pret/<int:pk>/", app_admin_required(views.supplier_price_import_detail), name="supplier_price_import_detail"),
    path("furnizori/liste-pret/<int:pk>/confirma/", app_admin_required(views.supplier_price_import_confirm), name="supplier_price_import_confirm"),
    ...
    path("stoc/vanzari/linii/<int:pk>/editeaza/", app_admin_required(views.sales_import_line_edit), name="sales_import_line_edit"),
    path("marje/", staff_member_required(views.margin_analysis), name="margin_analysis"),
    path("stoc/reaprovizionare/", app_admin_required(views.inventory_replenishment_create), name="inventory_replenishment_create"),
    ...
    path("metro/scanari/catalog-complet/", app_admin_required(views.metro_scrape_mass_start), name="metro_scrape_mass_start"),
    path("metro/scanari/catalog-api/", app_admin_required(views.metro_scrape_api_start), name="metro_scrape_api_start"),
    path("metro/scanari/extindere-rapida/", app_admin_required(views.metro_scrape_breadth_start), name="metro_scrape_breadth_start"),
    path("metro/scanari/acoperire-alfabetica/", app_admin_required(views.metro_scrape_alphabet_start), name="metro_scrape_alphabet_start"),
