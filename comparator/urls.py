...
urlpatterns = [
    ...
    path("facturi/", staff_member_required(views_documents.invoice_list), name="invoice_list"),
    path("facturi/inbox/", staff_member_required(views_documents.document_inbox), name="document_inbox"),
    path("facturi/adauga/", staff_member_required(views_documents.invoice_create), name="invoice_create"),
    path("facturi/<int:pk>/", staff_member_required(views_documents.invoice_detail), name="invoice_detail"),
    path("facturi/<int:pk>/editeaza/", staff_member_required(views_documents.invoice_edit), name="invoice_edit"),
    path("facturi/<int:pk>/sterge/", app_admin_required(views_documents.invoice_delete), name="invoice_delete"),
    path(
        "facturi/<int:pk>/fisier/",
        staff_member_required(views_documents.invoice_file_download),
        name="invoice_file_download",
    ),
    path(
        "facturi/<int:pk>/pagini/adauga/",
        staff_member_required(views_documents.invoice_pages_add),
        name="invoice_pages_add",
    ),
    path(
        "documente/pagini/<int:pk>/fisier/",
        staff_member_required(views_documents.document_page_download),
        name="document_page_download",
    ),
    path(
        "documente/pagini/<int:pk>/muta/",
        staff_member_required(views_documents.document_page_move),
        name="document_page_move",
    ),
    path(
        "documente/pagini/<int:pk>/sterge/",
        staff_member_required(views_documents.document_page_delete),
        name="document_page_delete",
    ),
    path(
        "facturi/<int:pk>/proceseaza/",
        staff_member_required(views_documents.invoice_process),
        name="invoice_process",
    ),
    path(
        "facturi/<int:pk>/calibrare-ocr/",
        staff_member_required(views_documents.invoice_evaluation_toggle),
        name="invoice_evaluation_toggle",
    ),
    path(
        "facturi/<int:pk>/versiuni/<int:revision_pk>/restaureaza/",
        staff_member_required(views_documents.invoice_revision_restore),
        name="invoice_revision_restore",
    ),
    path(
        "facturi/<int:pk>/revizuieste/",
        staff_member_required(views_documents.invoice_lines_review),
        name="invoice_lines_review",
    ),
    path(
        "facturi/<int:pk>/linie/adauga/",
        staff_member_required(views_documents.line_create),
        name="line_create",
    ),
    path("linii/<int:pk>/editeaza/", staff_member_required(views_documents.line_edit), name="line_edit"),
    path("linii/<int:pk>/sterge/", staff_member_required(views_documents.line_delete), name="line_delete"),
]
